namespace Forum.App.Menus
{
    ...
    public class AddReplyMenu : Menu, ITextAreaMenu, IIdHoldingMenu
    {
        ...
        public AddReplyMenu(ICommandFactory commandFactory, ILabelFactory labelFactory,
            ITextAreaFactory textAreaFactory, IForumReader reader, IPostService postService)
        {
        ...
        public override IMenu ExecuteCommand()
		{
            if (this.CurrentOption.IsField)
            {
                string fieldInput = " " + this.reader
                    .ReadLine(this.CurrentOption.Position.Left + 1, this.CurrentOption.Position.Top);

                this.Buttons[currentIndex] = this.labelFactory
                    .CreateButton(fieldInput, this.CurrentOption.Position, false, true);
